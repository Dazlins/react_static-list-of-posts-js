...
aut aut aut maxime quia temporibus ut omnis`}],Nc=[{id:1,name:"Leanne Graham",username:"Bret",email:"Sincere@april.biz"},{id:2,name:"Ervin Howell",username:"Antonette",email:"Shanna@melissa.tv"},{id:3,name:"Clementine Bauch",username:"Samantha",email:"Nathan@yesenia.net"},{id:4,name:"Patricia Lebsack",username:"Karianne",email:"Julianne.OConner@kory.org"},{id:5,name:"Chelsey Dietrich",username:"Kamren",email:"Lucio_Hettinger@annie.ca"},{id:6,name:"Mrs. Dennis Schulist",username:"Leopoldo_Corkery",email:"Karley_Dach@jasper.info"},{id:7,name:"Kurtis Weissnat",username:"Elwyn.Skiles",email:"Telly.Hoeger@billy.biz"},{id:8,name:"Nicholas Runolfsdottir V",username:"Maxime_Nienow",email:"Sherwood@rosamond.me"},{id:9,name:"Glenna Reichert",username:"Delphine",email:"Chaim_McDermott@dana.io"},{id:10,name:"Clementina DuBuque",username:"Moriah.Stanton",email:"Rey.Padberg@karina.biz"}],Pc=({user:e})=>{const{name:t,email:i}=e;return U.jsx("a",{className:"UserInfo",href:`mailto:${i}`,children:t})},Lc=({comment:e})=>{const{name:t,body:i,email:n}=e;return U.jsxs("li",{className:"CommentInfo",children:[U.jsx("p",{className:"CommentInfo__name",children:t}),U.jsx("p",{className:"CommentInfo__body",children:i}),U.jsx("a",{href:`mailto:${n}`,className:"CommentInfo__email",children:n})]})},Tc=({comments:e})=>U.jsx("ul",{className:"CommentList",children:e.map(t=>U.jsx(Lc,{comment:t},t.id))}),Mc=({post:e})=>{const{title:t,body:i,user:n,comments:a}=e,u=a&&a.length>0?U.jsx(Tc,{comments:a}):U.jsx("b",{"data-cy":"NoCommentsMessage",children:"No comments yet"});return U.jsxs("div",{className:"PostInfo",children:[U.jsxs("div",{className:"PostInfo__header",children:[U.jsx("h3",{className:"PostInfo__title",children:t}),U.jsxs("p",{children:[" Posted by  ",n&&U.jsx(Pc,{user:n})]})]}),U.jsx("p",{className:"PostInfo__body",children:i}),U.jsx("hr",{}),u]})},Rc=({posts:e})=>U.jsx("div",{className:"PostList",children:e.map(t=>U.jsx(Mc,{post:t},t.id))});function Dc(e){return Nc.find(t=>t.id===e)}function jc(e){return zc.filter(t=>t.postId===e)}const Oc=Cc.map(e=>({...e,user:Dc(e.userId),comments:jc(e.id)})),Fc=()=>U.jsxs("section",{className:"App",children:[U.jsx("h1",{className:"App__title",children:"Static list of posts"}),U.jsx(Rc,{posts:Oc})]});em(document.getElementById("root")).render(U.jsx(Fc,{}));
